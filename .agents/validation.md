...
- Use `bun run build` for route type generation, TypeScript checking, prerendering, and static packaging, including the standalone 404 file. The application TypeScript project includes `src/` and `stories/`.
