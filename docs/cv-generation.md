...
and Skills linking to the detailed CV. Retained contracting projects are being shortened individually. Graveyard management, insurance, mobile fueling, Eloqua, and warehouse robotics each use a single paragraph combining the description and contribution, with selected technologies. The short CV includes only extensive and recent
