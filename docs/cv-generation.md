...
and Skills linking to the detailed CV. All six individual contracting projects use a single paragraph combining the description and contribution, with selected technologies. The short CV includes only extensive and recent
