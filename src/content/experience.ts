    ...
    projects: [
      ...
      },
      {
        ...
        text: [
          ...
          "The application is part of a larger warehouse automation product that combines physical robots with an extensive software stack for autonomous warehouse operations. The web application provides the system's user interface.",
          'The overall system is a very large project developed by dozens of people.',
        ],
        roleText: [
