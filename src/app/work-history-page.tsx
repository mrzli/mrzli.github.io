...
const DATA: readonly Job[] = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        tech: 'Java, JSP, SOAP.',
        role: 'My role: I did the entire implementation of this interface.',
      },
      {
        description:
              ...
              <div key={projectIndex} className='my-6'>
                ...
                {(project.tech ?? project.role) && (
                  <ul className='ml-6 list-disc'>
                    {project.tech && <li>Tech used: {project.tech}</li>}
                    {project.role && <li>My role: {project.role}</li>}
                  </ul>
                )}
              </div>
            ))}
